...
:-------------------------:|:-------------------------:
![](https://i.imgur.com/SdRcEiY.jpg)  |  ![](https://i.imgur.com/CAppWSM.jpg)
...
```
python train_nerv_all.py  --outf 1120  --data_path data/bunny --vid bunny --data_split 1_1_1  \
   --conv_type convnext pshuffel --act gelu --norm none  --crop_list 640_1280 --resize_list -1 \
    --resize_list -1 --loss Fusion6  --enc_strds 5 4 4 2 2 --enc_dim 64_16 \
